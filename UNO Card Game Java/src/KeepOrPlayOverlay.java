...
public class KeepOrPlayOverlay extends WndInterface implements TurnDecisionOverlayInterface {
    ...
    public List<Button> buttonList; // List of buttons consisting of the Keep and Play buttons.


    public TurnActionFactory.TurnDecisionAction currentAction; // Reference to the TurnAction that triggered the display of this overlay

    private Card cardForChoice; // Reference to the dummy card that the overlay is making a decision about.

    private final Position cardPosition; // Position where the card in question is to be placed.
