...
public class PauseInterface extends WndInterface {
    ...
    private final List<Button> buttonList; // A list of all the buttons in the interface.


    private final GamePanel gamePanel; // A reference to the GamePanel to call back to it.

    private final List<String> leftMessages, rightMessages; // Text showing the messages with different controls.

    //  Initialise the interface with bounds makes it ready to use.
    //
    //  bounds: The region to draw this interface in.
...
//        }
     ...
     *
     *  actionID The actionID to map to an action from the pause menu.
     */
