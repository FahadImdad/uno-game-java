...
public class Deck extends Rectangle {
    ...
    //
    //      position: Position for the deck to appear in the game.
    ...
    //      Draws a back of a card to represent the deck position.
    ...
    //
    //      Card : A single card drawn from the deck.
    ...
    private void fillDeck() {
        deck.clear();
        // for each colour
        for(int colourID = 0; colourID < 4; colourID++) { //for all color red, blue, yellow, and green.
