...
public class AIPlayer extends Player {
   ...
   public enum AIStrategy { Offensive, Defensive, Chaotic, Random }
    ...
    private AIStrategy strategy; // The Strategy to be used for selecting how cards are played.


    private double delayTimer; // Timer used for delaying between actions.


    private int consideringPlayerID; // ID of the player being considered for calling out.


    private double consideringDelayTimer; // Delay till a decision is made about calling out.
...
//    private double consideringJumpInTimer;
   ...
   //   during update().
   //
   //   playerNumber:  The playerID associated with this player.
   //   playerName:  The name shown for this player.
   //   bounds:  The region for placing cards within.
   //   strategy:  The strategy the AI will use to play.
   //   showPlayerNameLeft:  When true, the player's name is centred to the left side of the bounds, otherwise it is centred on the top.
    ...
    public AIPlayer(int playerNumber, String playerName, Rectangle bounds, AIStrategy strategy, boolean showPlayerNameLeft) { // inheritance from Player class to AI player
...
//    }
    ...
    //
    //     validCards: A collection of cards that are all valid to be played.
    //     Card: A single valid card selected to be played.
    ...
    //
    //      decisionAction Reference to the current action requiring a decision.
   ...
   //      decisionAction:  Reference to the current action requiring a decision.
    ...
    private void checkCallUNO() {
        ...
        if(getHand().size() != 2) return; // Checking no of cards and updating
